...
- **2026-09-07 V2-5.4 ベータ安定化・v2.0.1-beta リリース**:
  ...
  - 対応: `installer/VolumeProfileManager.iss` から [Code] セクションを削除、Inno Setup 6.0.3 を固定、圧縮を zip に変更、`.github/workflows/release.yml` から .NET セットアップを削除

- **2026-09-07 V2-5.4 追加対応・v2.0.2-beta リリース**:
  - `v2.0.2-beta` タグ付け・プッシュ・GitHub Actions リリース完了
  - リリース: <https://github.com/ikaken/VolumeProfileManager/releases/tag/v2.0.2-beta>
  - アセット: `VolumeProfileManagerSetup.exe`（2,186,629 bytes、Inno Setup 6.0.3・zip 圧縮）
