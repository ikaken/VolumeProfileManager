...
- [ ] **V2-5.1 リリース候補確認**：最新タグ・Issue を再確認し、初回候補 `v2.0.0-beta` と変更内容を提示。実際の番号はこの時点で決定
- [ ] **V2-5.2 ベータ公開承認・実施**：タグ付け・プッシュ・公開の明示的な承認を得た後、対象コミットを確認して実施
- [ ] **V2-5.3 公開結果検証**：Actions の完了、インストーラー、Pre-release/Latest の分類、手動ダウンロードを確認（V2-R01 の公開後項目）
